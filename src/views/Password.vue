<template>
  ...
  <div class="container mt-3 text-center">
    <div class="container w-25 input-group mt-4 p-4">
        <span class="input-group-text">Password Size</span>
        <input v-model="passLen" type="text" class="form-control" aria-describedby="inputGroup-sizing-sm" id="passwordLen">
    </div>
    <div class="container d-flex justify-content-center mt-4 bg-dark text-light">
        <div class="container p-3">
            <div class="form-check form-switch">
                ...
                <label class="form-check-label" for="flexSwitchCheckDefault">Include Lowercase Letters</label>
            </div>
            <div class="form-check form-switch">
                <input v-model="useUppercase" class="form-check-input" type="checkbox" id="flexSwitchCheckChecked">
                <label class="form-check-label" for="flexSwitchCheckChecked">Include Uppercase Letters</label>
            </div>
        </div>
        <div class="container p-3">
            <div class="form-check form-switch">
            ...
            <div class="form-check form-switch">
                ...
                <label class="form-check-label" for="flexSwitchCheckCheckedDisabled">Include Special Characters</label>
            </div>
        </div>
    </div>
    <div class="container w-50 input-group mt-5 pt-4">
        <span class="input-group-text">Password</span>
        <input v-model="password" type="text" class="form-control" disabled>
    </div>
...
export default {
    ...
    updated() {
        const inputField = document.getElementById('passwordLen');
        inputField.defaultValue = this.passLen;
    },
    methods: {
